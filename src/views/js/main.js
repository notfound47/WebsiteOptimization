...
var pizzaElementGenerator = function(i) {
  ...
  // Moved selector outside of function to reduce the amount of times the element is retrieved
  ...
  // Moved selector outside of function to reduce the amount of times the element is retreived
  var randomPizzaContainer = document.getElementsByClassName("randomPizzaContainer");
  // Iterates through pizza elements on the page and changes their widths
  function changePizzaSizes(size) {

    
      // Renamed call of selector to variable of element and determined dx based on first container
...
var resizePizzas = function(size) {
  ...
  // Relocated call of function into 
